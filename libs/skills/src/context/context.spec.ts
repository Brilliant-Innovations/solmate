...
const features = (asOf: Instant): FeatureSnapshot => ({ id: uuid(1), assetId: IDS.asset as Uuid, asOf, featureEngineVersion: 'features-v2' as VersionId, provenance: 'LIVE', marketSnapshotId: null, features: { ret_15m: 0.04, rel_volume_60: 2.1, atr_14_pct: null }, regime: 'RISK_ON', marketSessions: ['US'], selfInfluenceSuppressed: false } as unknown as FeatureSnapshot);
