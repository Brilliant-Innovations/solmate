...
import { Amount, Instant, MintAddress, Nonce, Uuid } from '../primitives.js';
 ...
 */
export const EmergencyCommand = z.strictObject({
  commandId: Uuid,
  type: EmergencyCommandType,
  /** Required for EMERGENCY_CLOSE_ASSET; must be a held risk asset. */
