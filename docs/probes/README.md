...
| M7 | `m7-evidence-2026-09-08.md` — scope items, exit-gate acceptance and the §24.4 reconciliation cases mapped to code, tests and the hosted worker (two Trigger-V2-conditional cases carried to M8a) |
...
| M6 | `m6-status-2026-09-08.md` — P4 and P5 deliverables and acceptance mapped to code and tests (intelligence core and adapters, Trading Skill tools/guidelines/context, runner with adversary and cutoffs, automations and budgets, S1–S4, EVENT_WINDOW cap); status only: model/intelligence keys, run-rate, separate paper books in motion and adversarial review #2 still open. |
| M8b | `m8b-evidence-2026-09-08.md` — five direct-pool adapters verified against live mainnet accounts, quote-equals-simulation results per family, first full dry-run cycle, executor fallback harness; box stays open for the Jito-style landing option and the Profile 2 drill |
